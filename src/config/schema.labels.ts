...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "plugins.entries.*.trust": "Plugin Trust Policy",
  "plugins.entries.*.trust.tools": "Trusted Plugin Tools",
  "plugins.entries.*.trust.tools.allow": "Trusted Plugin Tool Allowlist",
